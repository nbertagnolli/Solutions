...
Just take the derivative with respect to $\mu$ of our function:

\[\ln (x | \mu, \sigma^2) = -\frac{1}{2\sigma^2} \sum_{n=1}^N (x_n - \mu)^2 - \frac{N}{2 }\ln \sigma^2 - \frac{N}{2}\ln(2\pi)\]

\begin{align*}
\frac{d}{d\mu} \ln (x | \mu, \sigma^2) &= \frac{1}{\sigma^2} \sum_{n=1}^N x_n - \mu\\
0 &= \sum_{n=1}^N x_n - \mu\\
...
Now repeat the same for $\sigma^2$
